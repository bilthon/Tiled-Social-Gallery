...
public class StaggeredGridView extends ViewGroup
{
    ...
    /**
     * Public interface similar to the AdapterView.OnItemClickListener.
     * Since the StaggeredGridView is extending a ViewGroup, I cannot use the interface
     * defined in an AdapterView.
     * <p>
     * TODO: Study the possibility to make StaggeredGridView extend AdapterView instead
     * of ViewGroup.
    ...
    public interface OnItemClickListener {
    	...
    	/**
    	 * Callback method to be invoked when an item in this Viewgroup has been clicked.<br>
    	 * @param parent The ViewGroup where the click happened
    	 * @param view The view within the StaggeredView that was clicked
